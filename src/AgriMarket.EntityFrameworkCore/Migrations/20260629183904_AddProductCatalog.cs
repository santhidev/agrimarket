        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresColdChain = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsFragile = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ShelfLifeHours = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppProductGrades_AppProducts_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppProductGrades_ProductId_Name",
                table: "AppProductGrades",
                columns: new[] { "ProductId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppProducts_Category",
                table: "AppProducts",
                column: "Category");
